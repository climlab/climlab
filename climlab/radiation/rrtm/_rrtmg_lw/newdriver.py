from rrtmg_lw_init.rrtmg_lw_init import rrtmg_lw_ini
from mcica_subcol_gen_lw.mcica_subcol_gen_lw import mcica_subcol_lw
from rrtmg_lw_rad.rrtmg_lw_rad import rrtmg_lw
from parrrtm.parrrtm import nbndlw, ngptlw
...
def driver(ncol, nlay, icld, permuteseed, irng, idrv, cpdair,
    ...
    mcica_subcol_lw(1, ncol, nlay, icld, permuteseed, irng, play,
