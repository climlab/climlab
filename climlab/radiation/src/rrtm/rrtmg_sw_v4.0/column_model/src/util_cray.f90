...
!                                                                       
!     GDATE AND FORMAT ARE FOR CYBER AND CRAY                           
!                                                                       
!       -- CYBER REQUIRES FORMAT (1X,A8)                                
!       -- CRAY  REQUIRES FORMAT (A8)                                   
!                                                                       
...
!                                                                       
!     GTIME AND FORMAT ARE FOR CYBER AND CRAY                           
!                                                                       
!       -- CYBER REQUIRES FORMAT (1X,A8)                                
!       -- CRAY  REQUIRES FORMAT (A8)                                   
!                                                                       
