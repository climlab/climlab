...
sys.path.insert(0, os.path.abspath('/home/moritz/PIK/subversion/working_dir/v-0.3.0.1-docstr_changes-ssh_local_host'))
...
project = u'climlab'
copyright = u'2016 (licensed under Creative Commons, see License), Moritz Kreuzer'
author = u'Moritz Kreuzer'
...
htmlhelp_basename = 'climlab-0301Documentationdoc'
...
latex_documents = [
  (master_doc, 'climlab-0301Documentation.tex', u'climlab-0.3 Documentation',
   u'Moritz Kreuzer', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = os.path.abspath('/home/moritz/PIK/subversion/documentation/climlab-0.3.0.1/sphinx/source/_static/logo.png')
...
man_pages = [
    (master_doc, 'climlab-0301documentation', u'climlab-0.3 Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'climlab-0301Documentation', u'climlab-0.3.0.1 Documentation',
   author, 'climlab-0301Documentation', 'One line description of project.',
   'Miscellaneous'),
]
